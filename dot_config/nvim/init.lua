...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>rf", builtin.oldfiles, { desc = '[S]earch Recent [Files ("." for repeat)' })
			vim.keymap.set("n", "<leader><leader>", builtin.buffers, { desc = "[ ] Find existing buffers" })
			vim.keymap.set("n", "<C-g>", builtin.git_files, {})
			vim.keymap.set("n", "<leader>/", builtin.current_buffer_fuzzy_find, { desc = "[ ] Find existing buffers" })
			vim.keymap.set("n", "<leader>stest", builtin.git_status)
	...
	{ -- Autoformat
		...
		opts = {
			...
			-- 	local disable_filetypes = { c = true, cpp = true, javascript = true, typescript = true, lua = true, rust=true}
			-- 	return {
			-- 		timeout_ms = 500,
